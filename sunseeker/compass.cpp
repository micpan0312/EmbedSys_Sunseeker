...
void setup_compass() {
  ...
  // change here for calib results 12/02/2022 -mp
  compass_x_offset = 58.89;
  compass_y_offset = 130.75;
  compass_z_offset = 382.53;

  compass_x_gainError = 0.90;
  compass_y_gainError = 0.92;
  compass_z_gainError = 0.79;
