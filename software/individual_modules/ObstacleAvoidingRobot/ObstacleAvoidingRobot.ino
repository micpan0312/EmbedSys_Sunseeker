...
*   Date: June 29 2020
*   Code version: n/a
*   Availability: https://www.the-diy-life.com/arduino-based-obstacle-avoiding-robot-car/
*
*   Modified by: Michael Pan
...
AF_DCMotor rightBack(3);                          //Create an object to control each motor
...
byte motorSpeed = 165;                             //The maximum motor speed
