...
# def win_model(path='/home/mp/yolov5-D435i/win_model.pt', autoshape=True, _verbose=True, device=None):
    # # YOLOv5 custom or local model /home/mp/yolov5-D435i/win_model.pt
    # return _create(path, autoshape=autoshape, verbose=_verbose, device=device)

def custom(path='path/to/model.pt', autoshape=True, _verbose=True, device=None):
    # YOLOv5 custom or local model /home/mp/yolov5-D435i
    return _create(path, autoshape=autoshape, verbose=_verbose, device=device)
