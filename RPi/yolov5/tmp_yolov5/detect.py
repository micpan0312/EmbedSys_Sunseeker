...
def run(
        ...
        # weights = '/usr/local/lib/python3.9/dist-packages/yolov5/win_model.pt',
        source=ROOT / '/home/mp/yolov5_detect',  # file/dir/URL/glob/screen/0(webcam)
        ...
        project='/home/mp/yolov5_results',  # save results to project/name
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # im0s = cv2.rotate(im0s, cv2.ROTATE_90_COUNTERCLOCKWISE)
